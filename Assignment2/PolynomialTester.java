...
public class PolynomialTester {
	...
	private static void testAddTerm_1()
	{
		...
		p1.addTermLast(new Term(4, new BigInteger("8")));
		p1.addTermLast(new Term(3, new BigInteger("6")));
		p1.addTermLast(new Term(2, new BigInteger("4")));
		p1.addTermLast(new Term(1, new BigInteger("2")));
		...
		p2.addTerm(new Term(0, new BigInteger("0")));
	...
	private static void testAddTerm_2()
	{
		...
		p1.addTerm(new Term(18, new BigInteger("17")));
		
		p1.addTerm(new Term(0, new BigInteger("17")));
	...
	private static void testEval_3()
	{
		...
		if (p1.eval(new BigInteger("2")).compareTo(new BigInteger("99")) == 0)
		{
			System.out.println("Passed: eval() - Test 1");
			return;
		}
	...
	private static void testEval_4()
	{
		...
		p1.addTerm(new Term(20, new BigInteger("4")));
		p1.addTerm(new Term(15, new BigInteger("3")));
		p1.addTerm(new Term(11, new BigInteger("-2")));
		p1.addTerm(new Term(3, new BigInteger("1")));
		p1.addTerm(new Term(0, new BigInteger("1")));
				
		if (p1.eval(new BigInteger("2")).compareTo(new BigInteger("4288521")) == 0)
		{
			System.out.println("Passed: eval() - Test 1");
			return;
		}
