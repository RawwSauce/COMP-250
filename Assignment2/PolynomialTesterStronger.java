...
public class PolynomialTesterStronger {
	...
	{	
		...
		{
			System.out.println("Passed: deepClone() Test 1");
			System.out.println("***TEST ENDED***\n");
			
			return;
		}
		System.out.println("Failed: deepClone() Test 1");
	...
	{	
		System.out.println("***TEST: testClone()_2***");
		...
		if (clone.checkEqual(poly))
		{
			System.out.println("Passed: deepClone() Test 2");
			System.out.println("***TEST ENDED***\n");
			
			return;
		}
		System.out.println("Failed: deepClone() Test 2");
	...
	private static void testAddTerm_4()
	{
		...
		System.out.println("TEST: testAddTerm_4");
		...
		p1.addTerm(new Term(1, new BigInteger("1")));
		p1.addTerm(new Term(2, new BigInteger("-1")));
		p1.addTerm(new Term(10, new BigInteger("-1"))); 
		p1.addTerm(new Term(-1, new BigInteger("1"))); // this shouldn't be added
